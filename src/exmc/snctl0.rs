...
impl W {
    ...
    #[doc = "Bit 13 - NWAIT signal enable"]
    #[inline]
    pub fn nrwten(&mut self) -> _NRWTENW {
        _NRWTENW { w: self }
    }
    #[doc = "Bit 12 - Write enable"]
    #[inline]
    ...
    #[doc = "Bit 9 - NWAIT signal polarity"]
    #[inline]
    pub fn nrwtpol(&mut self) -> _NRWTPOLW {
        _NRWTPOLW { w: self }
    }
    #[doc = "Bit 6 - NOR Flash access enable"]
    #[inline]
    pub fn nren(&mut self) -> _NRENW {
        _NRENW { w: self }
    }
    #[doc = "Bits 4:5 - NOR bank memory data bus width"]
    #[inline]
    pub fn nrw(&mut self) -> _NRWW {
        _NRWW { w: self }
    }
    #[doc = "Bits 2:3 - NOR bank memory type"]
    #[inline]
    pub fn nrtp(&mut self) -> _NRTPW {
        _NRTPW { w: self }
    }
    #[doc = "Bit 1 - NOR bank memory address/data multiplexing"]
    #[inline]
    pub fn nrmux(&mut self) -> _NRMUXW {
        _NRMUXW { w: self }
    }
    #[doc = "Bit 0 - NOR bank enable"]
    #[inline]
    pub fn nrbken(&mut self) -> _NRBKENW {
        _NRBKENW { w: self }
    }
}
