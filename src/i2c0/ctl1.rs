...
impl W {
    ...
    #[doc = "Bit 12 - Flag indicating DMA last transfer"]
    #[inline]
    pub fn dmalst(&mut self) -> _DMALSTW {
        _DMALSTW { w: self }
    }
    #[doc = "Bit 11 - DMA mode switch"]
    #[inline]
    pub fn dmaon(&mut self) -> _DMAONW {
        _DMAONW { w: self }
    }
    #[doc = "Bit 10 - Buffer interrupt enable"]
    #[inline]
    pub fn bufie(&mut self) -> _BUFIEW {
        _BUFIEW { w: self }
    }
    #[doc = "Bit 9 - Event interrupt enable"]
    #[inline]
    ...
    #[doc = "Bits 0:5 - I2C Peripheral clock frequency"]
    #[inline]
    pub fn i2cclk(&mut self) -> _I2CCLKW {
        _I2CCLKW { w: self }
    }
}
