...
impl W {
    ...
    #[doc = "Bit 8 - Backup Domain Write Enable"]
    #[inline]
    pub fn bkpwen(&mut self) -> _BKPWENW {
        _BKPWENW { w: self }
    }
    #[doc = "Bits 5:7 - Low Voltage Detector Threshold"]
    #[inline]
    pub fn lvdt(&mut self) -> _LVDTW {
        _LVDTW { w: self }
    }
    #[doc = "Bit 4 - Low Voltage Detector Enable"]
    #[inline]
    ...
    #[doc = "Bit 3 - Standby Flag Reset"]
    #[inline]
    pub fn stbrst(&mut self) -> _STBRSTW {
        _STBRSTW { w: self }
    }
    #[doc = "Bit 2 - Wakeup Flag Reset"]
    #[inline]
    pub fn wurst(&mut self) -> _WURSTW {
        _WURSTW { w: self }
    }
    #[doc = "Bit 1 - Standby Mode"]
    #[inline]
    pub fn stbmod(&mut self) -> _STBMODW {
        _STBMODW { w: self }
    }
    #[doc = "Bit 0 - LDO Low Power Mode"]
    #[inline]
    pub fn ldolp(&mut self) -> _LDOLPW {
        _LDOLPW { w: self }
    }
}
