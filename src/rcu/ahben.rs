...
impl W {
    ...
    #[doc = "Bit 0 - DMA0 clock enable"]
    #[inline]
    pub fn dma0en(&mut self) -> _DMA0ENW {
        _DMA0ENW { w: self }
    }
    #[doc = "Bit 1 - DMA1 clock enable"]
    #[inline]
    ...
    #[doc = "Bit 2 - SRAM interface clock enable when sleep mode"]
    #[inline]
    pub fn sramspen(&mut self) -> _SRAMSPENW {
        _SRAMSPENW { w: self }
    }
    #[doc = "Bit 4 - FMC clock enable when sleep mode"]
    #[inline]
    pub fn fmcspen(&mut self) -> _FMCSPENW {
        _FMCSPENW { w: self }
    }
    #[doc = "Bit 6 - CRC clock enable"]
    #[inline]
    ...
    #[doc = "Bit 8 - EXMC clock enable"]
    #[inline]
    pub fn exmcen(&mut self) -> _EXMCENW {
        _EXMCENW { w: self }
    }
    #[doc = "Bit 12 - USBFS clock enable"]
    #[inline]
