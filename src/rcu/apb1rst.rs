...
#[doc = r" Proxy"]
pub struct _TIMER1RSTW<'a> {
    w: &'a mut W,
}
impl<'a> _TIMER1RSTW<'a> {
...
#[doc = r" Proxy"]
pub struct _TIMER2RSTW<'a> {
    w: &'a mut W,
}
impl<'a> _TIMER2RSTW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _TIMER3RSTW<'a> {
    w: &'a mut W,
}
impl<'a> _TIMER3RSTW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _TIMER4RSTW<'a> {
    w: &'a mut W,
}
impl<'a> _TIMER4RSTW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _TIMER5RSTW<'a> {
    w: &'a mut W,
}
impl<'a> _TIMER5RSTW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _TIMER6RSTW<'a> {
    w: &'a mut W,
}
impl<'a> _TIMER6RSTW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 0 - TIMER1 timer reset"]
    #[inline]
    pub fn timer1rst(&mut self) -> _TIMER1RSTW {
        _TIMER1RSTW { w: self }
    }
    #[doc = "Bit 1 - TIMER2 timer reset"]
    #[inline]
    pub fn timer2rst(&mut self) -> _TIMER2RSTW {
        _TIMER2RSTW { w: self }
    }
    #[doc = "Bit 2 - TIMER3 timer reset"]
    #[inline]
    pub fn timer3rst(&mut self) -> _TIMER3RSTW {
        _TIMER3RSTW { w: self }
    }
    #[doc = "Bit 3 - TIMER4 timer reset"]
    #[inline]
    pub fn timer4rst(&mut self) -> _TIMER4RSTW {
        _TIMER4RSTW { w: self }
    }
    #[doc = "Bit 4 - TIMER5 timer reset"]
    #[inline]
    pub fn timer5rst(&mut self) -> _TIMER5RSTW {
        _TIMER5RSTW { w: self }
    }
    #[doc = "Bit 5 - TIMER6 timer reset"]
    #[inline]
    pub fn timer6rst(&mut self) -> _TIMER6RSTW {
        _TIMER6RSTW { w: self }
    }
    #[doc = "Bit 11 - Window watchdog timer reset"]
    #[inline]
    pub fn wwdgtrst(&mut self) -> _WWDGTRSTW {
        _WWDGTRSTW { w: self }
    }
    #[doc = "Bit 14 - SPI1 reset"]
    #[inline]
    ...
    #[doc = "Bit 25 - CAN0 reset"]
    #[inline]
    pub fn can0rst(&mut self) -> _CAN0RSTW {
        _CAN0RSTW { w: self }
    }
    #[doc = "Bit 26 - CAN1 reset"]
    #[inline]
    ...
    #[doc = "Bit 27 - Backup interface reset"]
    #[inline]
    pub fn bkpirst(&mut self) -> _BKPIRSTW {
        _BKPIRSTW { w: self }
    }
    #[doc = "Bit 28 - Power control reset"]
    #[inline]
    pub fn pmurst(&mut self) -> _PMURSTW {
        _PMURSTW { w: self }
    }
    #[doc = "Bit 29 - DAC reset"]
    #[inline]
