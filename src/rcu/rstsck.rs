...
impl W {
    ...
    #[doc = "Bit 0 - IRC40K enable"]
    #[inline]
    pub fn irc40ken(&mut self) -> _IRC40KENW {
        _IRC40KENW { w: self }
    }
    #[doc = "Bit 24 - Reset flag clear"]
    #[inline]
    pub fn rstfc(&mut self) -> _RSTFCW {
        _RSTFCW { w: self }
    }
}
