...
pub type SPI_DATA_R = crate::FieldReader<u16, u16>;
#[doc = "Field `SPI_DATA` writer - Data transfer register"]
pub type SPI_DATA_W<'a, const O: u8> = crate::FieldWriter<'a, u16, DATA_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_data(&mut self) -> SPI_DATA_W<0> {
        SPI_DATA_W::new(self)
    }
