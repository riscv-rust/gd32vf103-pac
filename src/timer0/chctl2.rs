...
pub type CH0NEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, CHCTL2_SPEC, bool, O>;
...
pub type CH0NP_W<'a, const O: u8> = crate::BitWriter<'a, u16, CHCTL2_SPEC, bool, O>;
...
pub type CH1NEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, CHCTL2_SPEC, bool, O>;
...
pub type CH1NP_W<'a, const O: u8> = crate::BitWriter<'a, u16, CHCTL2_SPEC, bool, O>;
...
pub type CH2NEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, CHCTL2_SPEC, bool, O>;
...
pub type CH2NP_W<'a, const O: u8> = crate::BitWriter<'a, u16, CHCTL2_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0nen(&mut self) -> CH0NEN_W<2> {
        CH0NEN_W::new(self)
    }
    #[doc = "Bit 3 - Channel 0 complementary output polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ch0np(&mut self) -> CH0NP_W<3> {
        CH0NP_W::new(self)
    }
    #[doc = "Bit 4 - Channel 1 capture/compare function enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch1nen(&mut self) -> CH1NEN_W<6> {
        CH1NEN_W::new(self)
    }
    #[doc = "Bit 7 - Channel 1 complementary output polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ch1np(&mut self) -> CH1NP_W<7> {
        CH1NP_W::new(self)
    }
    #[doc = "Bit 8 - Channel 2 capture/compare function enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch2nen(&mut self) -> CH2NEN_W<10> {
        CH2NEN_W::new(self)
    }
    #[doc = "Bit 11 - Channel 2 complementary output polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ch2np(&mut self) -> CH2NP_W<11> {
        CH2NP_W::new(self)
    }
    #[doc = "Bit 12 - Channel 3 capture/compare function enable"]
    #[inline(always)]
