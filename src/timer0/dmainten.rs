...
pub type CMTIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, DMAINTEN_SPEC, bool, O>;
...
pub type BRKIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, DMAINTEN_SPEC, bool, O>;
...
pub type CMTDEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, DMAINTEN_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmtie(&mut self) -> CMTIE_W<5> {
        CMTIE_W::new(self)
    }
    #[doc = "Bit 6 - Trigger interrupt enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn brkie(&mut self) -> BRKIE_W<7> {
        BRKIE_W::new(self)
    }
    #[doc = "Bit 8 - Update DMA request enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmtden(&mut self) -> CMTDEN_W<13> {
        CMTDEN_W::new(self)
    }
    #[doc = "Bit 14 - Trigger DMA request enable"]
    #[inline(always)]
