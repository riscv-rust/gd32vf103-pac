...
impl W {
    ...
    #[doc = "Bit 12 - Channel 3 over capture flag"]
    #[inline]
    pub fn ch3of(&mut self) -> _CH3OFW {
        _CH3OFW { w: self }
    }
    #[doc = "Bit 11 - Channel 2 over capture flag"]
    #[inline]
    pub fn ch2of(&mut self) -> _CH2OFW {
        _CH2OFW { w: self }
    }
    #[doc = "Bit 10 - Channel 1 over capture flag"]
    #[inline]
    ...
    #[doc = "Bit 7 - Break interrupt flag"]
    #[inline]
    pub fn brkif(&mut self) -> _BRKIFW {
        _BRKIFW { w: self }
    }
    #[doc = "Bit 6 - Trigger interrupt flag"]
    #[inline]
    pub fn trgif(&mut self) -> _TRGIFW {
        _TRGIFW { w: self }
    }
    #[doc = "Bit 5 - Channel commutation interrupt flag"]
    #[inline]
    pub fn cmtif(&mut self) -> _CMTIFW {
        _CMTIFW { w: self }
    }
    #[doc = "Bit 4 - Channel 3 capture/compare interrupt flag"]
    #[inline]
    pub fn ch3if(&mut self) -> _CH3IFW {
        _CH3IFW { w: self }
    }
    #[doc = "Bit 3 - Channel 2 capture/compare interrupt flag"]
    #[inline]
    pub fn ch2if(&mut self) -> _CH2IFW {
        _CH2IFW { w: self }
    }
    #[doc = "Bit 2 - Channel 1 capture/compare interrupt flag"]
    #[inline]
    pub fn ch1if(&mut self) -> _CH1IFW {
        _CH1IFW { w: self }
    }
    #[doc = "Bit 1 - Channel 0 capture/compare interrupt flag"]
    #[inline]
    pub fn ch0if(&mut self) -> _CH0IFW {
        _CH0IFW { w: self }
    }
    #[doc = "Bit 0 - Update interrupt flag"]
    #[inline]
    pub fn upif(&mut self) -> _UPIFW {
        _UPIFW { w: self }
    }
}
