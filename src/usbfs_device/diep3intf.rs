...
impl W {
    ...
    #[doc = "Bit 6 - IN endpoint NAK effective"]
    #[inline]
    pub fn iepne(&mut self) -> _IEPNEW {
        _IEPNEW { w: self }
    }
    #[doc = "Bit 4 - Endpoint Tx FIFO underrun"]
    #[inline]
    pub fn eptxfud(&mut self) -> _EPTXFUDW {
        _EPTXFUDW { w: self }
    }
    #[doc = "Bit 3 - Control in timeout interrupt"]
    #[inline]
    pub fn cito(&mut self) -> _CITOW {
        _CITOW { w: self }
    }
    #[doc = "Bit 1 - Endpoint finished"]
    #[inline]
