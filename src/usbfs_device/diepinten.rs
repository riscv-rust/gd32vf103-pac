...
#[doc = r" Proxy"]
pub struct _EPTXFUDENW<'a> {
    w: &'a mut W,
}
impl<'a> _EPTXFUDENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 3 - Control IN timeout condition interrupt enable (Non-isochronous endpoints)"]
    #[inline]
    pub fn citoen(&mut self) -> _CITOENW {
        _CITOENW { w: self }
    }
    #[doc = "Bit 4 - Endpoint Tx FIFO underrun interrupt enable bit"]
    #[inline]
    pub fn eptxfuden(&mut self) -> _EPTXFUDENW {
        _EPTXFUDENW { w: self }
    }
    #[doc = "Bit 6 - IN endpoint NAK effective interrupt enable"]
    #[inline]
    pub fn iepneen(&mut self) -> _IEPNEENW {
        _IEPNEENW { w: self }
    }
}
