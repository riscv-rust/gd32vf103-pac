...
pub type EPRXFOVR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP2INTF_SPEC, bool, O>;
...
pub type BTBSTP_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP2INTF_SPEC, bool, O>;
impl R {
