...
#[doc = r" Proxy"]
pub struct _STPCNT_RXDPIDW<'a> {
    w: &'a mut W,
}
impl<'a> _STPCNT_RXDPIDW<'a> {
...
impl R {
    ...
    #[inline]
    pub fn stpcnt_rxdpid(&self) -> STPCNT_RXDPIDR {
        let bits = {
            const MASK: u8 = 0x03;
            const OFFSET: u8 = 29;
...
impl W {
    ...
    #[doc = "Bits 29:30 - SETUP packet count/Received data PID"]
    #[inline]
    pub fn stpcnt_rxdpid(&mut self) -> _STPCNT_RXDPIDW {
        _STPCNT_RXDPIDW { w: self }
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline]
