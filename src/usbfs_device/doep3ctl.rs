...
#[doc = r" Proxy"]
pub struct _SD1PID_SODDFRMW<'a> {
    w: &'a mut W,
}
impl<'a> _SD1PID_SODDFRMW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _SD0PID_SEVENFRMW<'a> {
    w: &'a mut W,
}
impl<'a> _SD0PID_SEVENFRMW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn eofrm_dpid(&self) -> EOFRM_DPIDR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[inline]
    pub fn sd1pid_soddfrm(&mut self) -> _SD1PID_SODDFRMW {
        _SD1PID_SODDFRMW { w: self }
    }
    #[doc = "Bit 28 - SD0PID/SEVENFRM"]
    #[inline]
    pub fn sd0pid_sevenfrm(&mut self) -> _SD0PID_SEVENFRMW {
        _SD0PID_SEVENFRMW { w: self }
    }
    #[doc = "Bit 27 - Set NAK"]
    #[inline]
    ...
    #[doc = "Bit 15 - Endpoint active"]
    #[inline]
    pub fn epact(&mut self) -> _EPACTW {
        _EPACTW { w: self }
    }
    #[doc = "Bits 0:10 - maximum packet length"]
    #[inline]
    pub fn mpl(&mut self) -> _MPLW {
        _MPLW { w: self }
    }
}
