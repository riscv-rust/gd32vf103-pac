...
pub type TLEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DOEP3LEN_SPEC, u32, u32, 19, O>;
#[doc = "Field `PCNT` reader - Packet count"]
pub type PCNT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PCNT` writer - Packet count"]
pub type PCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DOEP3LEN_SPEC, u16, u16, 10, O>;
...
pub type STPCNT_RXDPID_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DOEP3LEN_SPEC, u8, u8, 2, O>;
impl R {
