...
impl W {
    ...
    #[doc = "Bit 0 - Global interrupt enable"]
    #[inline]
    pub fn ginten(&mut self) -> _GINTENW {
        _GINTENW { w: self }
    }
    #[doc = "Bit 7 - Tx FIFO threshold"]
    #[inline]
    pub fn txfth(&mut self) -> _TXFTHW {
        _TXFTHW { w: self }
    }
    #[doc = "Bit 8 - Periodic Tx FIFO threshold"]
    #[inline]
    pub fn ptxfth(&mut self) -> _PTXFTHW {
        _PTXFTHW { w: self }
    }
}
