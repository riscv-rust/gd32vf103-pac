...
#[doc = r" Value of the field"]
pub struct PXNCIE_ISOONCIER {
    bits: bool,
}
impl PXNCIE_ISOONCIER {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bit(&self) -> bool {
        self.bits
...
#[doc = r" Proxy"]
pub struct _GNPINAKIEW<'a> {
    w: &'a mut W,
}
impl<'a> _GNPINAKIEW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _PXNCIE_ISOONCIEW<'a> {
    w: &'a mut W,
}
impl<'a> _PXNCIE_ISOONCIEW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn pxncie_isooncie(&self) -> PXNCIE_ISOONCIER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 21;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        PXNCIE_ISOONCIER { bits }
    }
...
impl W {
    ...
    #[doc = "Bit 1 - Mode fault interrupt enable"]
    #[inline]
    pub fn mfie(&mut self) -> _MFIEW {
        _MFIEW { w: self }
    }
    #[doc = "Bit 2 - OTG interrupt enable"]
    #[inline]
    pub fn otgie(&mut self) -> _OTGIEW {
        _OTGIEW { w: self }
    }
    #[doc = "Bit 3 - Start of frame interrupt enable"]
    #[inline]
    ...
    #[doc = "Bit 4 - Receive FIFO non-empty interrupt enable"]
    #[inline]
    pub fn rxfneie(&mut self) -> _RXFNEIEW {
        _RXFNEIEW { w: self }
    }
    #[doc = "Bit 5 - Non-periodic TxFIFO empty interrupt enable"]
    #[inline]
    pub fn nptxfeie(&mut self) -> _NPTXFEIEW {
        _NPTXFEIEW { w: self }
    }
    #[doc = "Bit 6 - Global non-periodic IN NAK effective interrupt enable"]
    #[inline]
    pub fn gnpinakie(&mut self) -> _GNPINAKIEW {
        _GNPINAKIEW { w: self }
    }
    #[doc = "Bit 7 - Global OUT NAK effective interrupt enable"]
    #[inline]
    pub fn gonakie(&mut self) -> _GONAKIEW {
        _GONAKIEW { w: self }
    }
    #[doc = "Bit 10 - Early suspend interrupt enable"]
    #[inline]
    pub fn espie(&mut self) -> _ESPIEW {
        _ESPIEW { w: self }
    }
    #[doc = "Bit 11 - USB suspend interrupt enable"]
    #[inline]
    ...
    #[doc = "Bit 13 - Enumeration finish interrupt enable"]
    #[inline]
    pub fn enumfie(&mut self) -> _ENUMFIEW {
        _ENUMFIEW { w: self }
    }
    #[doc = "Bit 14 - Isochronous OUT packet dropped interrupt enable"]
    #[inline]
    pub fn isoopdie(&mut self) -> _ISOOPDIEW {
        _ISOOPDIEW { w: self }
    }
    #[doc = "Bit 15 - End of periodic frame interrupt enable"]
    #[inline]
    pub fn eopfie(&mut self) -> _EOPFIEW {
        _EOPFIEW { w: self }
    }
    #[doc = "Bit 18 - IN endpoints interrupt enable"]
    #[inline]
    pub fn iepie(&mut self) -> _IEPIEW {
        _IEPIEW { w: self }
    }
    #[doc = "Bit 19 - OUT endpoints interrupt enable"]
    #[inline]
    pub fn oepie(&mut self) -> _OEPIEW {
        _OEPIEW { w: self }
    }
    #[doc = "Bit 20 - isochronous IN transfer not complete interrupt enable"]
    #[inline]
    pub fn isoincie(&mut self) -> _ISOINCIEW {
        _ISOINCIEW { w: self }
    }
    #[doc = "Bit 21 - periodic transfer not compelete Interrupt enable(Host mode)/isochronous OUT transfer not complete interrupt enable(Device mode)"]
    #[inline]
    pub fn pxncie_isooncie(&mut self) -> _PXNCIE_ISOONCIEW {
        _PXNCIE_ISOONCIEW { w: self }
    }
    #[doc = "Bit 25 - Host channels interrupt enable"]
    #[inline]
    pub fn hcie(&mut self) -> _HCIEW {
        _HCIEW { w: self }
    }
    #[doc = "Bit 26 - Periodic TxFIFO empty interrupt enable"]
    #[inline]
    pub fn ptxfeie(&mut self) -> _PTXFEIEW {
        _PTXFEIEW { w: self }
    }
    #[doc = "Bit 28 - ID pin status change interrupt enable"]
    #[inline]
    pub fn idpscie(&mut self) -> _IDPSCIEW {
        _IDPSCIEW { w: self }
    }
    #[doc = "Bit 29 - Disconnect interrupt enable"]
    #[inline]
    pub fn discie(&mut self) -> _DISCIEW {
        _DISCIEW { w: self }
    }
    #[doc = "Bit 30 - Session interrupt enable"]
    #[inline]
    pub fn sesie(&mut self) -> _SESIEW {
        _SESIEW { w: self }
    }
    #[doc = "Bit 31 - Wakeup interrupt enable"]
    #[inline]
    pub fn wkupie(&mut self) -> _WKUPIEW {
        _WKUPIEW { w: self }
    }
}
