...
impl W {
    ...
    #[doc = "Bit 8 - SRP capability enable"]
    #[inline]
    pub fn srpcen(&mut self) -> _SRPCENW {
        _SRPCENW { w: self }
    }
    #[doc = "Bit 9 - HNP capability enable"]
    #[inline]
    pub fn hnpcen(&mut self) -> _HNPCENW {
        _HNPCENW { w: self }
    }
    #[doc = "Bits 10:13 - USB turnaround time"]
    #[inline]
    pub fn utt(&mut self) -> _UTTW {
        _UTTW { w: self }
    }
    #[doc = "Bit 29 - Force host mode"]
    #[inline]
    pub fn fhm(&mut self) -> _FHMW {
        _FHMW { w: self }
    }
    #[doc = "Bit 30 - Force device mode"]
    #[inline]
    pub fn fdm(&mut self) -> _FDMW {
        _FDMW { w: self }
    }
}
