...
impl W {
    ...
    #[doc = "Bit 5 - ACK interrupt enable"]
    #[inline]
    pub fn ackie(&mut self) -> _ACKIEW {
        _ACKIEW { w: self }
    }
    #[doc = "Bit 7 - USB bus error interrupt enable"]
    #[inline]
    pub fn usberie(&mut self) -> _USBERIEW {
        _USBERIEW { w: self }
    }
    #[doc = "Bit 8 - Babble error interrupt enable"]
    #[inline]
    pub fn bberie(&mut self) -> _BBERIEW {
        _BBERIEW { w: self }
    }
    #[doc = "Bit 9 - request queue overrun interrupt enable"]
    #[inline]
    pub fn reqovrie(&mut self) -> _REQOVRIEW {
        _REQOVRIEW { w: self }
    }
    #[doc = "Bit 10 - Data toggle error interrupt enable"]
    #[inline]
    pub fn dterie(&mut self) -> _DTERIEW {
        _DTERIEW { w: self }
    }
}
